...
class RepositoryParticipantJdbi(private val handle: Handle) : RepositoryParticipant {
    ...
    override fun deleteById(id: Int) {
        handle.createUpdate("DELETE FROM dbo.participants WHERE id = :id")
            .bind("id", id)
            .execute()
    }
